...
describe('broccoli-funnel', function(){
  ...
  describe('lookupDestinationPath', function() {
    ...
    it('returns the input path if no getDestinationPath method is defined', function() {
      ...
      expect(node.lookupDestinationPath(new Entry(relativePath, 0, 0, 33188))).to.be.equal(relativePath);
    });
    ...
    it('returns the output of getDestinationPath method if defined', function() {
      ...
      expect(node.lookupDestinationPath(new Entry(relativePath, 0, 0, 33188))).to.be.equal(expected);
    });
    ...
    it('does not call getDestinationPath for directories', () => {
      ...
      node.lookupDestinationPath(new Entry(relativePath, 0, 0, 16877));
